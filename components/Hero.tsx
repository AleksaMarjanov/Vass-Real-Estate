...
whileInView="show"
viewport={{ once: true }}
className={`${styles.xPaddings} flex items-center justify-center flex-row max-[768px]:flex-col`}
>      
    <motion.div
    ...
    >
        ...
        className="flex flex-col items-left justify-left mt-0 max-[425px]:px-2"
        >
        ...
        className="max-[425px]:flex items-center justify-center">
